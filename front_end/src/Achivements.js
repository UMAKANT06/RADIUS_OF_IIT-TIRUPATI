...
export function Achivements(props) {
  const { nodes, materials } = useGLTF("./assets/achivements building ().glb");
  return (
...
useGLTF.preload("./assets/achivements building ().glb");