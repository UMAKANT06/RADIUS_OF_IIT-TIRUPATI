...
export function Pond(props) {
  const { nodes, materials } = useGLTF("/assets/Pond.glb");
  return (
    <group {...props} dispose={null} scale={[30,30,30]} position={[0,1,500]}>
      <group
...
useGLTF.preload("/assets/Pond.glb");